...
cfg.mercados = {
  ...
  {name = "Mercado 24 Horas", id=52, x=1121.7554931641, y=-3146.90625, z=-37.062767028809},
}

foods = {}

foods["leite"] = {name="Leite", price=3, logo="leite.png"}
foods["agua"] = {name="Água mineral", price=2, logo="agua.png"}
foods["vinho"] = {name="Vinho", price=8, logo="vinho.png"}
foods["sucodelaranja"] = {name="Suco", price=8, logo="suco.png"}
foods["limonada"] = {name="Limonada", price=14, logo="limonada.png"}
foods["vodka"] = {name="Vodka", price=30, logo="vodka.png"}
foods["pao"] = {name="Pão de sal", price=2, logo="pao.png"}
foods["pipoca"] = {name="Pipoca", price=2, logo="pipoca.png"}
foods["espaguete"] = {name="Espaguete", price=8, logo="espaguete.png"}
foods["pizza"] = {name="Pizza", price=65, logo="pizza.png"}
foods["rosquinha"] = {name="Rosquinha", price=4, logo="rosquinha.png"}
foods["gps"] = {name="GPS", price=300, logo="gps.png"}